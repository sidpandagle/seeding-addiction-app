      ...
      <ScrollView className="flex-1">
          ...
          <View className="p-5 mb-4 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-700 rounded-2xl">
            <View className="flex-row items-center justify-between mb-4">
              ...
              <Pressable
                ...
                className="flex-row items-center gap-2 px-3 py-2 bg-gray-50 border border-gray-200 rounded-xl dark:bg-gray-800 dark:border-gray-700 active:bg-gray-100 dark:active:bg-gray-700"
              >
        ...
        <View className="px-6 pb-6">
          ...
          <View className="gap-3">
            <View className="p-5 bg-blue-50 border border-blue-200 dark:bg-blue-950/30 dark:border-blue-800 rounded-xl">
            ...
            <View className="p-5 bg-emerald-50 border border-emerald-200 dark:bg-emerald-950/30 dark:border-emerald-800 rounded-xl">
            ...
            <View className="p-5 bg-amber-50 border border-amber-200 dark:bg-amber-950/30 dark:border-amber-800 rounded-xl">
